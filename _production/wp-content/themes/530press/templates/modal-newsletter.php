<div class="js-modal modal" aria-hidden="true" aria-labelledby="modal-title" role="dialog">

	<div class="modal__box">

		<div class="modal__block">
			<div class="modal__title" id="modal-title">Subscribe to our Newsletter!</div>
			<hr />
		...
		<a role="button" class="modal__close" id="js-close-modal">
