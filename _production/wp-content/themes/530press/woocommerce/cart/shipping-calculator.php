...
<form class="shipping_calculator section" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<a href="#" class="shipping-calculator-button  button--secondary"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a>
