		...
		<div class="article">
			...
			<table>
				<thead>
					<tr>
					  <th scope="col" style="text-align:left; width: 15%;"><?php _e('Image', 'woocommerce-pip'); ?></th>
						<th scope="col" style="text-align:left; width: 10%;"><?php _e('SKU', 'woocommerce-pip'); ?></th>
						<th scope="col" style="text-align:left; width: 30%;"><?php _e('Product', 'woocommerce-pip'); ?></th>
						<th scope="col" style="text-align:left; width: 30%;"><?php _e('Quantity', 'woocommerce-pip'); ?></th>
						<th scope="col" style="text-align:left; width: 15%;"><?php _e('Price', 'woocommerce-pip'); ?></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
				...
				<tbody>
					<?php echo woocommerce_pip_custom_order_items_table($order, TRUE); ?>
				</tbody>
			</table>
			<?php } else { ?>
			<table>
